...
We believe the issue of caselaw consistency to boil down to two issues: firstly, the estimation of location of a case in a case-space and, secondly, to quantitatively conceptualizing consistency of caselaw among court chambers. In both cases, we build on existing work, which we shortly explore in more detail. We combine both strands of research and apply it to a collegial court context to measure consistency of caselaw across chambers of one court, more specifically the Czech Constitutional Court.
...
### Estimation of location of court decisions
